    ...
    return (
        <div classeName="conteiner">
            ...
            < div className="texto1">
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus ornare cursus nulla. Nulla vestibulum sollicitudin</p>
                </div>
            ...
            <input type="text" value="Digite sua Mensagem" className="inputMensagem" /><i aria-hidden="true" className ="LupaMessagem" ><MdKeyboardArrowRight/></i>
            </div>
        </div>
    )
}